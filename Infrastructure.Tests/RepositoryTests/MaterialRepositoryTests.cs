...
public class MaterialRepositoryTests : IDisposable
{
    ...
    {
        var material = await repo.CreateMaterialAsync(new CreateMaterialDTO(2, "Testing", "Testing for dummies.", FileType.Pdf,
            "MaterialsData/test.Pdf"));

        var expected = new MaterialDTO(4, 2, "Testing", "Testing for dummies.", FileType.Pdf,
            "MaterialsData/test.Pdf");
    ...
    {
        var material = await repo.CreateMaterialAsync(new MaterialDTO(42, 2, "Testing", "Testing for dummies.", FileType.Pdf,
            "MaterialsData/test.Pdf"));
    ...
    {
        var actual = await repo.UpdateMaterialAsync(2, new CreateMaterialDTO(2, "Testing", "Testing for dummies.", FileType.Pdf,
            "MaterialsData/test.Pdf"));
    ...
    {
        var actual = await repo.UpdateMaterialAsync(42, new CreateMaterialDTO(2, "Testing", "Testing for dummies.", FileType.Pdf,
            "MaterialsData/test.Pdf"));
    ...
    public async void ReadAsync_given_id_returns_materialDTO()
    {
        ...
        var expMaterial = new MaterialDTO(2, 1, "C# global using functionality", "Global using is an easy way to import packages globally", FileType.Pdf,"MaterialsData/test.Pdf" );
